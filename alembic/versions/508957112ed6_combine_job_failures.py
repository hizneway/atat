...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "portfolio_id", postgresql.UUID(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["portfolio_id"],
            ["portfolios.id"],
            name="portfolio_job_failures_portfolio_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="portfolio_job_failures_pkey"),
    )
    op.create_table(
        "environment_role_job_failures",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column("task_id", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column(
            "environment_role_id",
        ...
        sa.ForeignKeyConstraint(
            ...
            name="environment_role_job_failures_environment_role_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="environment_role_job_failures_pkey"),
    )
    op.create_table(
        "environment_job_failures",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column("task_id", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column(
            "environment_id", postgresql.UUID(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["environment_id"],
            ["environments.id"],
            name="environment_job_failures_environment_id_fkey",
        ),
