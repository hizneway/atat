"""add app invite permission provisioning stage
...
def upgrade():
    op.alter_column(
        ...
        type_=sa.Enum(
            ...
            "PRINCIPAL_APP_INVITE_PERMISSION_CREATED",
            "PRINCIPAL_APP_INVITE_PERMISSION_IN_PROGRESS",
            "PRINCIPAL_APP_INVITE_PERMISSION_FAILED",
