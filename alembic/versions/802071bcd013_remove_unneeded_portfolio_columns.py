...
def downgrade():
    ...
    op.add_column(
        "portfolios",
        sa.Column("complexity_other", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "portfolios",
        sa.Column("native_apps", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "portfolios",
        sa.Column("app_migration", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "portfolios",
        sa.Column("dev_team_other", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "portfolios",
        sa.Column("team_experience", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "portfolios",
        sa.Column(
